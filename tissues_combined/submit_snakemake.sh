...
LSF_PARAMS="-o sm_logs/raw_qc-%J-output.log -e logs/raw_qc-%J-error.log -q long -G team152 -n 4 -M 60000 -a 'memlimit=True' -R 'select[mem>60000] rusage[mem=60000] span[hosts=1]'"
JOBS=10

# Submit the Snakefile to the cluster using snakemake
source ~/.bashrc
conda activate scvi-env
snakemake -p --snakefile Snakefile --cluster "bsub $LSF_PARAMS" --jobs $JOBS --conda-frontend conda --use-conda /lustre/scratch126/humgen/projects/sc-eqtl-ibd/analysis/bradley_analysis/results/tissues_combined/{rectum,ti,blood}/objects/adata_PCAd_batched.h5ad
