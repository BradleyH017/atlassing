...
# Get lineage
lineage_list=post_workflow_analyses/scripts/categories_epi_B.txt
...
# bsub -o ../logs/calc_markers-%J-%I-output.log -e ../logs/calc_markers-%J-%I-error.log -q teramem -G team152 -n 1 -M 750000 -a "memlimit=True" -R "select[mem>750000] rusage[mem=750000] span[hosts=1]" -J "calculating_markers_category[1-6]" < submit_marker_analysis_category.sh 
